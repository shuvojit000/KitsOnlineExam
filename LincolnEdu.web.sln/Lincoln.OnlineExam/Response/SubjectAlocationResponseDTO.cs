   ...
   public class SubjectAllocationResponseDTO
    ...
    //{
       ...
       // public string CourseName { get; set; }
        ...
        public SubjectAllocationDetails AllocationDetails { get; set; }
        public List<SubjectAllocationDetails> SubAllocationDetails { get; set; }
    }

    public class SubjectAllocationDetails
    {
